...
$token = isset($_GET['token_id'])?$_GET['token_id']:"";
$sqlA = "SELECT * FROM enattente where token =?";
   ...
   <div class="d-none container-fluid  payment justify-content-center margin">
    <form class="col-sm-12 col-lg-10 mt-3 shadow radius d-flex overflow-h" id="form">
      <div class="col-8">
        ...
        <br>
             <div><h4>Ravis de vous revoir :</h4></div>
            <div class="col-11">
                    <?php
                      $nom = $row['nom'];
                      $prenom = $row['prenom'];
                      ...
                      $nombre_Adulte = $row["nombre_d'adulte"];
                      $nombre_Enfant = $row["nombre_d'enfant"];
                      $Arrive = $row["date_d'arrivé"];
                      $Depart = $row["date_de_départ"];
                      $token_id = $row['token'];
                     ?>
                     <input class="token" type="hidden" value="<?php echo $token_id; ?>">
                <div class="d-flex">
                   <label class="fw-bold col-6" for="nom">Nom : <br><input class="bg-transparent nom col-11 border radius-1" type="text" name="nom" id="nom" value="<?php echo "$nom";?>" disabled></label><br>
                   <label class="fw-bold col-6" for="prenom">Prénom : <br><input class="bg-transparent prenom col-12  border radius-1" type="text" name="prenom" id="prenom" value="<?php echo "$prenom";?>" disabled></label>
                </div>
                <label class="fw-bold col-12" for="mail">Mail : <br><input class="bg-transparent mail col-12 border radius-1" type="text" name="mail" id="mail" value="<?php echo "$mail";?>" disabled></label>
                <div>
                    <div><h4>Adresse</h4></div>
                    <div class="d-flex">
                        <label for="adresse" class="fw-bold col-6">Adresse Line 1 :<br><input autocomplete="street-address" class="border radius-1 col-11" type="text" id="adresse" value="<?php echo "$adresse";?>" disabled></label>
                        <label for="adresse1" class="fw-bold col-6">Adresse Line 2 :<br><input autocomplete="address-level1" class="border radius-1 col-12" type="text" id="adresse1" value="<?php echo "$adresse1";?>" disabled></label>
                    </div>
                    <div class="d-flex">
                        <label for="zip" class="fw-bold col-12">Code postale ou Zip code :<br><input autocomplete="postal-code" class="border radius-1 col-12" type="text" id="zip" value="<?php echo "$zip";?>" disabled></label>
                    </div>
                    <div class="d-flex">
                    <label for="pay" class="col-6 fw-bold">Pay :<br><input autocomplete="country" class="border radius-1 col-11" type="text" id="pay" value="<?php echo "$pay";?>" disabled></label>
                    <label for="ville" class="col-6 fw-bold">Ville :<br><input autocomplete="address-level2" class="border radius-1 col-12" type="text" id="ville" value="<?php echo "$ville";?>" disabled></label>
                    </div>
                </div>
                <div>
                <div><h4>Reservation</h4></div> 
                 <label for="selection" class="fw-bold col-12"><div class="d-flex"><div class="col-6">Traitement : <span> <?php echo "$traitement";?> </span></div> <div class="col-6 d-flex justify-content-end"><div class="border btnscale border-1 radius Edit px-2 btnES">Modifier</div><div class="border btnscale border-1 radius Save px-2 btnES">Sauvegarder</div></div></div> 
                 <select name="selection" id="selection" class="selection py-1 bg-transparent border radius-1 col-12 mt-1" disabled>
              ...
              <div class="d-flex">
                ...
                <label class="col-12 fw-bold" for="nbrA">Nombre d'adulte : 
                    <br>
                    <div class="d-flex">
                    <input class="border radius-1 col-11 nombre nbrA" type="number" min="0" max="4" name="nbrA" id="nbrA" value="<?php echo "$nombre_Adulte";?>" disabled>
                    </div>
                </label>
                </div>
                <div class="d-flex align-items-center col-6">
                <label class="col-12 fw-bold" for="nbrE">Nombre d'enfant (6 - 12 ans (50%)) : <br>
                    <div class="d-flex">
                    <input class="border radius-1 col-12 nombre nbrE" type="number" min="0" max="4" name="nbrE" id="nbrE" value="<?php echo "$nombre_Enfant";?>" disabled >
                    </div>
                </label>
                </div>
              </div>
              <div class="d-flex">
                  <label class="col-6 fw-bold" for="date">Date d'arrivé : <br>
                    <input type="date" name="dateArrive" class="dateA col-11" id="date" value="<?php echo "$Arrive";?>" disabled>
                  </label>
                 <label class="col-6 fw-bold" for="dateD">Date de départ : <br>
                    <input type="date" name="dateDepart" class="dateD col-12" id="date" value="<?php echo "$Depart";?>" disabled>
                </label>
             </div>
            </div>
        <br>
...
<!--         <div>
      ...
      <div class="col-4 bg-5 bg-shadow text-white border-radius-top-right border-radius-bottom-right">
            <?php
                $PAdulte = $row['prix_adulte'];
                $PEnfant = $row['prix_enfant'];
                $PAE = $row['prixAE'];
                $PT = $row['prix_du_traitement'];
                $Nuit = $row['nombre_de_séjour'];
                $Totale1 = $row['prix_totale1'];
                $Totale = $row['total_sf'];
                $FraisPaypal = $row['frai_paypal'];
                $TotaleAF = $row["prix_totale"];
            ?>
        <div class="p-3 bg-6">
        <div style="display: flex;" class="align-items-center ">
            <h5 class="fw-bold">Traitement :</h5>
            <h5 class="amount"><?php echo "$PT";?></h5>
            <h5>€</h5>
        </div>
        <hr>
        <div style="display: flex;" class="align-items-center ">
            <h5 class="fw-bold mb-0">Adulte :</h5>
            <h5 class="adulteAmount mb-0"><?php echo "$PAdulte";?></h5>
            <h5 class="mb-0">€</h5>
        </div>
        <br>
        <div style="display: flex;" class="align-items-center ">
            <h5 class="fw-bold mb-0">Enfant :</h5>
            <h5 class="enfantAmount mb-0"><?php echo "$PEnfant";?></h5>
            <h5 class="mb-0">€</h5>
        </div>
        <br>
        <div style="display: flex;">
            <h5 class="fw-bold">Total :</h5>
            <h5 class="amountAE" ><?php echo "$PAE";?></h5>
            <h5 class="mb-0">€</h5>
        </div>
        <hr>
        <div style="display: flex;">
            <h5 class="fw-bold">Nuit :</h5>
            <h5 id="passNight" class="passNight" ><?php echo "$Nuit";?></h5>
        </div>
        <div style="display: flex;">
        ...
        <div class="mt-2" style="display: flex;">
            <h5 class="fw-bold">Total :</h5>
            <h5 class="amountNuit" ><?php echo "$Totale1";?></h5>
            <h5 class="mb-0">€</h5>
        </div>
        <div class="mt-2" style="display: flex;">
            <h5 class="fw-bold">Acompte 30% :</h5> 
            <h5 class="amountNuitTrente"><?php echo "$Totale";?></h5> 
            <h5 class="mb-0">€</h5>
        </div>
        <hr>
        <!-- ACTIVITE ABANDONNER -->
<!--         <div style="display: flex;" class="align-items-center "> 
        ...
        <div style="display: flex;">
            ...
            <h4 class="amountPaypal" ><?php echo "$FraisPaypal";?></h4>
            <h4>€</h4>
        </div>
        <div style="display: flex;">
            <h2 class="fw-bold">Total :</h2>
            <h2 class="amount2" ><?php echo "$TotaleAF";?></h2>
            <h2>€</h2>
        </div>
            <br>
           <div id="cardPay">
   ...
   <div class="d-sm-none d-none payment_m justify-content-center margin">
    <form class=" shadow-1 radius-m d-flex overflow-h" id="form">
      <div>
        ...
        <br>
             <div><h5 class="text-center">Ravis de vous revoire :</h5></div>
            <div class="container-fluid">
                <div class="d-flex">
                   <label class="col-6" for="nom">Nom : <br><input class="bg-transparent nom col-11 border radius-1" type="text" name="nom" id="nom" value="<?php echo "$nom";?>"></label><br>
                   <label class="col-6" for="prenom">Prénom : <br><input class="bg-transparent prenom col-12  border radius-1" type="text" name="prenom" id="prenom" value="<?php echo "$prenom";?>"></label>
                </div>
                <label class="col-12" for="mail">Mail : <br><input class="bg-transparent mail col-12 border radius-1" type="text" name="mail" id="mail" value="<?php echo "$mail";?>"></label>
                <div>
                    <div><h5>Adresse</h5></div>
                    <div class="d-flex">
                        <label for="adresse" class="col-6">Adresse Line 1 :<br><input autocomplete="street-address" class="border radius-1 col-11" type="text" id="adresse" value="<?php echo "$adresse";?>"></label>
                        <label for="adresse1" class="col-6">Adresse Line 2 :<br><input autocomplete="address-level1" class="border radius-1 col-12" type="text" id="adresse1" value="<?php echo "$adresse1";?>"></label>
                    </div>
                    <div>
                        <label for="zip" class="col-12">Code postale ou Zip code :<br><input autocomplete="postal-code" class="border radius-1 col-12" type="text" id="zip" value="<?php echo "$zip";?>"></label>
                    </div>
                    <div class="d-flex">
                    <label for="pay" class="col-6">Pay :<br><input autocomplete="country" class="border radius-1 col-11" type="text" id="pay" value="<?php echo "$pay";?>"></label>
                    <label for="ville" class="col-6">Ville :<br><input autocomplete="address-level2" class="border radius-1 col-12" type="text" id="ville" value="<?php echo "$ville";?>"></label>
                    </div>
                </div>
                <div>
                <div><h5>Reservation</h5></div>
                 <label for="selection" class="col-12">Traitement : <span> <?php echo "$traitement";?> </span> <br>
              ...
              <div>
                ...
                <label class="col-12" for="nbrA">Nombre d'adulte : 
                    <br>
                    <div class="d-flex">
                    <input class="border radius-1 col-12 nombre nbrA" type="number"name="nbrA" id="nbrA" value="<?php echo "$nombre_Adulte";?>">
                    </div>
                </label>
                </div>
                <div class="d-flex align-items-center">
                <label class="col-12" for="nbrE">Nombre d'enfant (6 - 12 ans (50%)) : <br>
                    <div class="d-flex">
                    <input class="border radius-1 col-12 nombre nbrE" type="number" name="nbrE" id="nbrE" value="<?php echo "$nombre_Enfant";?>">
                    </div>
                </label>
                </div>
              </div>
              <div class="d-flex">
                  <label class="col-6" for="date">Date d'arrivé : <br>
                    <input type="date" name="dateArrive" class="dateA col-11" id="date" value="<?php echo "$Arrive";?>">
                  </label>
                 <label class="col-6" for="dateD">Date de départ : <br>
                 <input type="date" name="dateDepart" class="dateD col-12" id="date" value="<?php echo "$Depart";?>">
                 </label>
             </div>
             <br>
             <div>
        ...
        <div class="image p-3 d-flex justify-content-center align-items-center bulle border-radius-top-left border-radius-bottom-left col-1">
          ...
          <div class="col-7 pb-2 floating-bar shadow bg-5m border-radius-top-left border-radius-bottom-left">
           <div class="bar pt-2 container-fluid ps-3 bg-6 mobile-suivi border-radius-top-left border-radius-bottom-left">
            ...
            <p class="amount"><?php echo "$PT";?></p>
            <p>€</p>
             </div>
             <hr>
            <div style="display: flex;" class="align-items-center ">
            <p class="fw-bold mb-0">Adulte :</p>
            <p class="adulteAmount mb-0"><?php echo "$PAdulte";?></p>
            <p class="mb-0">€</p>
             </div>
             <div style="display: flex;" class="align-items-center ">
            <p class="fw-bold mb-0">Enfant :</p>
            <p class="enfantAmount mb-0"><?php echo "$PEnfant";?></p>
            <p class="mb-0">€</p>
             </div>
             <div style="display: flex;">
            <p class="fw-bold">Total :</p>
            <p class="amountAE" ><?php echo "$PAE";?></p>
            <p class="mb-0">€</p>
            </div>
            <hr>
            <div style="display: flex;">
            <p class="fw-bold">Nuit :</p>
            <p id="passNight" class="passNight" ><?php echo "$Nuit";?></p>
            </div>
            <div style="display: flex;">
            ...
            <p class="amountNuit mb-0" ><?php echo "$Totale1";?></p>
            <p class="mb-0">€</p>
            </div>
            <div class="mt-2" style="display: flex;">
            <p class="fw-bold mb-0">Acompte 30% :</p> 
            <p class="amountNuitTrente mb-0"><?php echo "$Totale";?></p> 
            <p class="mb-0">€</p>
            </div>
            <hr>
            <!-- ACTIVITE PRIX -->
<!--             <div style="display: flex;" class="align-items-center "> 
            ...
            <p class="amountPaypal" ><?php echo "$FraisPaypal";?></p>
            <p>€</p>
            </div>
            <div style="display: flex;">
            <h5 class="fw-bold">Total :</h5>
            <h5 class="amount2" ><?php echo "$TotaleAF";?></h5>
            <input type="hidden" class="TotalAmount2" value="<?php echo "$TotaleAF";?>">
            <h5>€</h5>
            </div>
           </div>  
        </div>
    ...
    <div class="All">
        ...
        <input type="hidden" name="dure" class="dure" id="dure" value="100.00">
    </div>
