...
<!--         <div style="display: flex;" class="align-items-center "> 
        ...
        <div style="display: flex;">
            ...
            <br>
           <div id="cardPay" class="d-flex justify-content-center">
            <button type="button" class="col-11 btn fw-bold border text-white btnscale AttenteR">Reservez</button>
           </div>
        </div>   
      </div>
    </form>
...
<!--         <div class="d-flex">
        ...
        <div id="cardPaym" class="d-flex justify-content-center">
         <button type="button" class="col-11 btn fw-bold border border-2 btnscale radius attenteR">Reservez</button>
        </div>
        </div>
      </div>
        </div>
