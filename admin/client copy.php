...
<body>
    ...
    <?php
        if( $catchResult->num_rows > 0) {
                         ...
                         $date = $row["date d'enregistrement"];
        ...
        <div class="d-flex">
            ...
            <table class="col-12">
                ...
                <?php
                    if( $catchResult->num_rows > 0) {
                        ...
                        if ( $row['id'] == $id) {
                            echo "<tr>";
                                echo "<td class='id text-center'>".$adresse."</td>" ;
            ...
            <div class="col-12">
                <table class="col-12">
                    <tr>
                        <th class="ps-2 th" colspan="5">Prix total :</th>
                    </tr>
                    <tr>
                        <th class="ps-2">Prix traitement :</th>
                        <th class="ps-2">Nombre de séjour :</th>    
                        <th class="ps-2">Prix des activités :</th>    
                    ...
                    echo "<tr>";
                     ...
                     echo "<td class='ps-2'>".$nbrAD." nuits"."</td>";
                     echo "<td class='ps-2'>".$row['prix_des_activités']." $"."</td>";
            ...
            <br>
            <div class="form">
                <select name="selection" class="bungalow">
    ...
    $(document).ready(function(){
        ...
        if(verification == ''){
            ...
            $('.btnBungalow').click(function(){
                const selectBungalow = $('.bungalow').val();
           $.ajax({
                url:'db/bungalow.php',
                type:'POST',
                data:{id: id, bungalow : selectBungalow},
        ...
        $('.form').hide()
        $('.assigne').html(`<h5 class="py-3 col-12 mb-0 text-center text-white green fw-bold">Ce client est assigné au : ${verification}</h5>`)
        } 
        let nom = $('.nom').val();
