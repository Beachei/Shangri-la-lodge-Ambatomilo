...
<body>
    ...
    <div class="d-flex">
        ...
        <button type="button" class="ms-3 end">Séjour terminer</button>
        <button type="button" class="ms-3 cancel">Séjour annuler</button>
    </div>
        ...
        <div class="d-flex">
            ...
            <div class="d-flex">
                ...
                <?php
                        switch($row['status']){
                            case 1:
                                echo "<div class='border col-10 text-center radius green fw-bold text-white status'>";
                ...
                <table class="col-12"> 
                    <tr>
                        ...
                        if ( $row['payer'] == 1) {
                            ...
                            echo "<th class='ps-2 th'colspan='2'>Prix total : ".$row['prix_totale1']." €</th>";
                            echo "<th class='ps-4 th'colspan='4'>Prix total : "."La totalité du séjour est payer"."</th>";
                        }
                        ?>
                        <th class='ps-2 th totalPayer'colspan='4'>Prix total : La totalité du séjour est payer</th>
                    </tr>
                    <tr>
...
<script type="module">
    ...
    $(document).ready(function(){
        ...
        $('.totalPayer').hide();
        $(document).on('click','.Tpayer', function(){
